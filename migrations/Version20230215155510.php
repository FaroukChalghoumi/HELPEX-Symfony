 ...
 */
final class Version20230215155510 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD service_id INT DEFAULT NULL, ADD diplome VARCHAR(255) DEFAULT NULL, ADD tarif DOUBLE PRECISION DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP service_id, DROP diplome, DROP tarif');
    }
}
