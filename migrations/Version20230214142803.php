 ...
 */
final class Version20230214142803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, sexe VARCHAR(255) NOT NULL, adresse LONGTEXT NOT NULL, adresse_visibility TINYINT(1) NOT NULL, numtel VARCHAR(255) NOT NULL, num_tel_visibility TINYINT(1) NOT NULL, pdp VARCHAR(255) DEFAULT NULL, bio LONGTEXT DEFAULT NULL, date_naissance DATE NOT NULL, date_naissance_visibility TINYINT(1) NOT NULL, diplome VARCHAR(255) DEFAULT NULL, tarif DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
